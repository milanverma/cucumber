Feature: Identify all elements on form and submit
  ...
  Scenario Outline: Open SmartBear.com website and fill multiple values
  	Given Chrome browser should be opened
    When SmartBear website is launched
    ...
    Examples: 
      ...
      | Milan   | Verma    | Male   | 2   | 1/1/2000     | Red Tea    | Break              | Europe    | Navigation Commands |
  ...
  Scenario: Open SmartBear.com website and fill sample data
  	Given Chrome browser should be opened
    When SmartBear website is launched
   ...
   Scenario: Open SmartBear.com website and attempt to submit form without filling mandatory fields
   	Given Chrome browser should be opened
    When SmartBear website is launched
