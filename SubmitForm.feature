Feature: Identify all elements on form and submit
  ...
  Scenario: Open zephyrcodecontest.com website and fill sample data
  	Given Chrome browser should be opened
    When Zephyrcodecontest website is launched
   ...
   Scenario: Open zephyrcodecontest.com website and attempt to submit form without filling mandatory fields
   	Given Chrome browser should be opened
    When Zephyrcodecontest website is launched
